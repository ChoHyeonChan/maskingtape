...
|---|---|---|---|---|---|---|
| address | 1.000 | 1.000 | 1.000 | 76 | 0 | 0 |
| card | 1.000 | 1.000 | 1.000 | 55 | 0 | 0 |
| email | 1.000 | 1.000 | 1.000 | 109 | 0 | 0 |
| name | 0.879 | 0.529 | 0.661 | 181 | 25 | 161 |
| phone | 1.000 | 1.000 | 1.000 | 253 | 0 | 0 |
| rrn | 1.000 | 1.000 | 1.000 | 70 | 0 | 0 |
| **overall** | **0.967** | **0.822** | **0.889** | 744 | 25 | 161 |

## 난이도(difficulty)별 결과

| group | precision | recall | f1 | tp | fp | fn |
|---|---|---|---|---|---|---|
| easy | 0.987 | 0.879 | 0.930 | 391 | 5 | 54 |
| hard | 0.946 | 0.767 | 0.848 | 353 | 20 | 107 |
