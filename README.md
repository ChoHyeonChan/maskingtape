...
| 놓치는 입력 | 잡히는 입력 | 종류 |
|---|---|---|
| `김포시 김포대로 123` | `김포시 사우동 12-3` | 주소 — 시·군 뒤에 구·동 없이 바로 도로명이 옴. 시/도 없는 주소는 시·군 뒤에 구·동·읍·면·리가 와야 주소로 보므로 통째로 놓친다([#425](https://github.com/ChoHyeonChan/maskingtape/issues/425)) |
...
> 생년월일 2자리 연도(#399). 모두 코드와 회귀 테스트로 고쳤다.
