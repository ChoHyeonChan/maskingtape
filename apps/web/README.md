...
**담당: plana([@plana1470](https://github.com/plana1470), 입력·하이라이트 뷰) + imsoo ([@imsoo0816](https://github.com/imsoo0816), 결과·배치 화면)** · 상태: ✅ 입력·하이라이트 뷰 완료(접근성·프라이버시 배너·확신도 슬라이더 포함), 🚧 결과·배치 화면 진행 중
